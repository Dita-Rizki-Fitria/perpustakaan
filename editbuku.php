...
<body>
<form action="action/edit1.php" method="POST" enctype="multipart/form-data">
    ...
    ?>
        ...
        <div class="text-dark p-4 col-4">
            <ins>
                      <h3><strong>Edit Buku</strong></h3>
                  </ins>
            <div class="conten">
                <div class="text-dark p-6 ">
                    <strong>
                              <p>Merubah Data Buku Baru</p>
                          </strong>
                    <div class="rounded-pill alert alert-secondary ">
                        <div class="form-group text-dark   ">
                            <label for="" class="control-label">Id Buku</label>
                            <input type="text" class="form-control form-control-sm" name="id_buku" value="<?php echo $ary['id_buku'] ?>">
                        </div>
                        <div class="form-group  text-dark">
                            <label for="" class="control-label">Judul Buku</label>
                            <input type="text" class="form-control form-control-sm" name="judul_buku" value="<?php echo $ary['judul_buku'] ?>">
                        </div>
                        <div class="form-group  text-dark">
                            <label for="" class="control-label">Penerbit</label>
                            <select class="custom-select custom-select-sm" name="penerbit" value="<?php echo $ary['penerbit'] ?>">
                        ...
                        <div class="form-group  text-dark">
                            ...
                            <input type="text" class="form-control form-control-sm" name="pengarang" value="<?php echo $ary['pengarang'] ?>">
                        </div>
                        <div class="form-group  text-dark">
                            <label for="" class="control-label">Kategori</label>
                            <select class="custom-select custom-select-sm" name="kategori" value="<?php echo $ary['kategori'] ?>">
                                  <option selected>Select</option>
                                  <option value="1">A</option>
                                  <option value="2">B</option>
                                  <option value="3">C</option>
                        ...
                        <div class="form-group  text-dark">
                            ...
                            <select class="custom-select custom-select-sm" name="tahun_terbit" value="<?php echo $ary['tahun_terbit'] ?>">
                                  <option selected>Select</option>
                                  <option value="1">A</option>
                                  <option value="2">B</option>
                                  <option value="3">C</option>
                        ...
                        <div class="form-group  text-dark">
                            ...
                            <select class="custom-select custom-select-sm" stok="stok" value="<?php echo $ary['stok'] ?>">
                                  <option selected>Select</option>
                                  <option value="1">A</option>
                                  <option value="2">B</option>
                                  <option value="3">C</option>
                        ...
                        <button type="submit" class="btn btn-primary btn" name="update">Update</button>
                    </div>
                </div>
</form>
            </div>
        ...
        <div class="table-responsive">
            <div class="text-dark col p-6">
                ...
                <div class="text-dark p-4 ">
                    <br>
                    <a class="btn btn-primary" href="buku.php" role="button">TAMBAHKAN DATA</a>
                    <br>
                    <strong>
                        <p>Data Buku</p>
                    </strong>
