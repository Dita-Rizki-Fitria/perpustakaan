    ...
    ?>
        ...
        <div class="text-dark p-4 col-4">
            ...
            <form action="action/edit.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id_kategori" value="<?php echo $ary['id_kategori'] ?>">
            <div class="conten">
                <div class="text-dark p-6 ">
                    <strong>
                              <p>Merubah Kategori Baru</p>
                          </strong>
                    <div class="rounded-pill alert alert-secondary ">
                        <div class="form-group text-dark   ">
                            <label for="" class="control-label">Kategori</label>
                            <input type="text" class="form-control form-control-sm" name="kategori" value="<?php echo $ary['kategori'] ?>">
                        </div>

                        <button type="submit" class="btn btn-primary btn" name="ubah">Update</button>
                    </div>
                </div>
            </div>
            </form>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a href="editkategori.php" class="btn btn-secondary">Tidak</a>
